              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      id="taxType"
                      value={legalData.tax_type}
                      disabled
                      className="bg-gray-50 border-gray-200 text-gray-600 cursor-not-allowed capitalize"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      id="streetAddress"
                      value={legalData.street_address}
                      disabled
                      className="bg-gray-50 border-gray-200 text-gray-600 cursor-not-allowed"
